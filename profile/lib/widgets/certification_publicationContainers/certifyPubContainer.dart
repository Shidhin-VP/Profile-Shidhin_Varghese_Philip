                          ...
                          : IconButton(
                              onPressed: () {
                                showDialog(
                                  ...
                                  builder: (context) {
                                    return AlertDialog(
                                      // constraints: BoxConstraints(maxWidth: getScreenWidth(context)/2,maxHeight: getScreenHeight(context)/2),
                                      title: Center(
                                        child: Text(
                                          "Credential",
                                          style: TextStyle(
                                      ...
                                      content: Column(
                                        ...
                                        children: [
                                          SizedBox(
                                            ...
                                            child: Image.asset(
                                              'assets/images/Certifications/snowpro-certification.png',
                                            ),
                                          ),
                                          SizedBox(height: 5),
                                          Text(
                                            "${item['subTitle']} - ${item['title']} Certification",
                                            style: TextStyle(
                                              color: Colors.green,
                                            ),
                                          ),
